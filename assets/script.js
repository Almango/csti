...
const questions = [
    { q: "作为T方的你，手枪局输了，下一局你会选择？", options: [{ t: "纯eco，为团队下一局考虑", type: "tactical" }, { t: "起沙鹰，相信自己能翻盘", type: "aggressive" }, { t: "半甲Tec10，稳扎稳打", type: "steady" }, { t: "让队友发把枪，一起配合打", type: "troll" }] },
    { q: "作为CT方的你，手枪局赢了，下一局你会选择？", options: [{ t: "起野牛冲锋，反正对面没经济", type: "pp19" }, { t: "起长枪打配合，坚守阵地", type: "steady" }, { t: "起鸟狙+57，求稳拿信息", type: "lone" }, { t: "先全甲沙鹰，下把起大狙", type: "troll" }] },
    { q: "作为CT，对方rush B点，你是B点唯一防守者，你会？", options: [{ t: "直接前顶，先秒一个是一个", type: "troll" }, { t: "后撤等队友回防，保存实力", type: "team" }, { t: "扔烟拖时间，疯狂报点求支援", type: "steady" }, { t: "找角度打游击，能杀几个是几个", type: "lone" }] },
    { q: "队友全死了，你面对1v3残局，你会？", options: [{ t: "冷静分析，寻找逐个击破的机会", type: "steady" }, { t: "直接拉出去，反正输了也不亏", type: "troll" }, { t: "保枪，为团队经济考虑", type: "steady" }, { t: "相信自己，这波能操作", type: "lone" }] },
    { q: "你的队友起大狙经常白给，你会在怎么做？", options: [{ t: "提醒队友别再起狙了", type: "tactical" }, { t: "让他把狙丢给我，我来carry", type: "aggressive" }, { t: "不管他，他爱咋玩就咋玩", type: "troll" }, { t: "狠狠的压力，玩不来别玩！", type: "troll" }] },
    { q: "进攻方，你更喜欢哪种打法？", options: [{ t: "默认开局，收集信息再决定", type: "tactical" }, { t: "直接rush，速度就是一切", type: "aggressive" }, { t: "执行既定战术，按部就班", type: "team" }, { t: "单摸找机会，制造多线压力", type: "lone" }] },
    { q: "关于道具使用，你的态度是？", options: [{ t: "必须买满，道具是战术核心", type: "tactical" }, { t: "有剩余钱就买，没有就算了", type: "steady" }, { t: "给队友发道具，配合团队", type: "team" }, { t: "烟闪随便扔，差不多就行", type: "troll" }] },
    { q: "连续输了5局，来到0:5的比分，你时常会？", options: [{ t: "失去信心", type: "troll" }, { t: "调整战术", type: "tactical" }, { t: "转起来", type: "forsaken" }, { t: "稳扎稳打", type: "steady" }] },
    { q: "你的经济管理习惯是？", options: [{ t: "严格控制，确保每局都有长枪", type: "steady" }, { t: "该花就花，不保留遗憾", type: "aggressive" }, { t: "根据团队情况灵活调整", type: "team" }, { t: "有钱就起狙，没钱就沙鹰", type: "troll" }] },
    { q: "作为突破手，你冲进去发现3个敌人，你会？", options: [{ t: "能换一个是一个，为队友创造机会", type: "team" }, { t: "拉枪线硬刚，相信自己能秒完", type: "aggressive" }, { t: "退回来重新组织进攻", type: "steady" }, { t: "找掩体打游击，拖延时间", type: "tactical" }] },
    { q: "你如何看待保枪这个行为？", options: [{ t: "多一杆枪，多一份实力", type: "steady" }, { t: "不到万不得已不会保", type: "aggressive" }, { t: "看情况，该保就保", type: "lone" }, { t: "不保枪，多杀一个是一个", type: "troll" }] },
    { q: "你的开麦沟通风格是？", options: [{ t: "详细报点，包括血量、位置、武器", type: "team" }, { t: "简单明了，只说关键信息", type: "tactical" }, { t: "可惜兄弟、好枪兄弟", type: "troll" }, { t: "偶尔开麦，更多靠意识", type: "troll" }] },
    { q: "当你在Nuke三楼看到黄房上的敌人大狙背身，而你只有一把沙鹰，此时你会？", options: [{ t: "往对面头上打，直接颗秒", type: "aggressive" }, { t: "往身上打，降低容错率", type: "steady" }, { t: "选择不打，多拿点信息", type: "lone" }, { t: "拖延时间，为队友创造机会", type: "team" }] },
    { q: "遇到对面开挂，你会？", options: [{ t: "正常打，用实力说话", type: "tactical" }, { t: "随便打了，就当是练枪", type: "steady" }, { t: "直接躺平，太TM晦气了", type: "tactical" }, { t: "你先开的，我也开转", type: "forsaken" }] },
    { q: "你最喜欢的武器组合是？", options: [{ t: "AK/M4 + 满道具", type: "tactical" }, { t: "大狙 + 沙鹰", type: "sniper" }, { t: "野牛/P90，你猜我野牛到哪了？", type: "pp19" }, { t: "内格夫/连喷，快乐就完事", type: "troll" }] },
    { q: "队友犯错了，你的反应是？", options: [{ t: "压力队友，再乱搞就摆烂", type: "troll" }, { t: "指出问题，教他正确做法", type: "tactical" }, { t: "无所谓，谁都有失误", type: "troll" }, { t: "默默叹气，自己多打几个", type: "lone" }] },
    { q: "对于游戏输赢，你的态度是？", options: [{ t: "必须赢，竞技游戏就是要上分", type: "aggressive" }, { t: "输赢无所谓，量力而行即可", type: "steady" }, { t: "竞技游戏，配合到位即可", type: "team" }] }
];
